...
class SentiAnalyzer:
    ...
    def probWordPositiveAndNegative(self, sentidata, word, idxWord): # sentidata and word : data from outside / idxWord : input word
        pointedWord = word[idxWord]
        reviews = [int(float(row[-1])) for row in sentidata] #row[-1] is the result of the review is positive or not
        ...
        # P(A and B), A = positive review B = the word is occurred
        positive = 0
